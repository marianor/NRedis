...
namespace Framework.Caching.Protocol.Tests
{
    ...
    public class RespClientTest
    {
        ...
        {
            var transport = Mock.Of<ITransport>(t => t.Send(It.IsAny<string>()) == "|3\r\n$3\r\nfoo\r\n$-1\r\n$3\r\nbar\r\n");
        ...
        {
            var transport = Mock.Of<ITransport>(t => t.Send(It.IsAny<string>()) == "+\r\n");
            var target = new RespClient(Mock.Of<ITransportSettings>(t => t.CreateTransport() == transport));
            var request = Mock.Of<IRequest>();
        ...
        {
            var transport = Mock.Of<ITransport>(t => t.Send(It.IsAny<string>()) == "+foo\r\n");
            var target = new RespClient(Mock.Of<ITransportSettings>(t => t.CreateTransport() == transport));
            var request = Mock.Of<IRequest>();
        ...
        {
            var transport = Mock.Of<ITransport>(t => t.Send(It.IsAny<string>()) == "+foo\r ");
            var target = new RespClient(Mock.Of<ITransportSettings>(t => t.CreateTransport() == transport));
            var request = Mock.Of<IRequest>();
        ...
        {
            var transport = Mock.Of<ITransport>(t => t.Send(It.IsAny<string>()) == ":34\r\n");
            var target = new RespClient(Mock.Of<ITransportSettings>(t => t.CreateTransport() == transport));
            var request = Mock.Of<IRequest>();
        ...
        {
            var transport = Mock.Of<ITransport>(t => t.Send(It.IsAny<string>()) == ":34\r ");
            var target = new RespClient(Mock.Of<ITransportSettings>(t => t.CreateTransport() == transport));
            var request = Mock.Of<IRequest>();
        ...
        {
            var transport = Mock.Of<ITransport>(t => t.Send(It.IsAny<string>()) == "$0\r\n\r\n");
            var target = new RespClient(Mock.Of<ITransportSettings>(t => t.CreateTransport() == transport));
            var request = Mock.Of<IRequest>();
        ...
        {
            var transport = Mock.Of<ITransport>(t => t.Send(It.IsAny<string>()) == "$-1\r\n");
            var target = new RespClient(Mock.Of<ITransportSettings>(t => t.CreateTransport() == transport));
            var request = Mock.Of<IRequest>();
        ...
        {
            var transport = Mock.Of<ITransport>(t => t.Send(It.IsAny<string>()) == "$8\r\nfoo\r\nbar\r\n");
            var target = new RespClient(Mock.Of<ITransportSettings>(t => t.CreateTransport() == transport));
            var request = Mock.Of<IRequest>();
        ...
        {
            var transport = Mock.Of<ITransport>(t => t.Send(It.IsAny<string>()) == "*0\r ");
            var target = new RespClient(Mock.Of<ITransportSettings>(t => t.CreateTransport() == transport));
            var request = Mock.Of<IRequest>();
        ...
        {
            var transport = Mock.Of<ITransport>(t => t.Send(It.IsAny<string>()) == "*2\r\n$3\r\nfoo\r\n$3\r\nbar\r\n");
            var target = new RespClient(Mock.Of<ITransportSettings>(t => t.CreateTransport() == transport));
            var request = Mock.Of<IRequest>();
        ...
        {
            var transport = Mock.Of<ITransport>(t => t.Send(It.IsAny<string>()) == "*5\r\n:1\r\n:2\r\n:3\r\n:4\r\n$6\r\nfoobar\r\n");
            var target = new RespClient(Mock.Of<ITransportSettings>(t => t.CreateTransport() == transport));
            var request = Mock.Of<IRequest>();
